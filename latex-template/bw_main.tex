...
\usepackage[boxbw,sectionmark,nodate,cs,epi,bib,hints,fancycover]{bubu}
\addbibresource{refs.bib}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\title{\textcolor{bubured}{\textrm{\LaTeX}\ Template}}
...
Please ignore the LSP errors here (if you're using one).
The LSP does not recognize references like \texttt{firstthm}
since there is no explicit label as such. However, the code
compiles completely fine since \texttt{tcolorbox} sets up the
